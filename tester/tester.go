...
func DoRequestOnServer(t *testing.T, jar *cookiejar.Jar, port string, method string, url string, authHeader string, payload string, expectedStatus int, expectedBody string) string {
